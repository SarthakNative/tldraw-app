      ...
      <div className="max-w-8xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
           ...
           className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold px-4 py-2 md:px-6 md:py-3 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-2 cursor-pointer group"
          >
